...
---
# werden
- tricky verb can be used in many ways!
- can be used as:
	- Vollverb
	- Hilfsverb
- it means - to become, to get, to turn
- can be used in 5 different ways:
	...
	- hilfsverb
		...
		- werden + passiv
		- werden + konj II
- it's Partizip II can be - "geworden" and "worden" both
...
1. werden as a vollverb - when talking about a change or development (ex- reich/arm werden)
	- werden + Nomen
		- bekommen Lisa and Hans ein Kind? Ja, sie werden bald eltern
		- was willst du später mal werden? Ich will architekt werden
		- was bist du nun geworden? ich bin Anwalt geworden
	- werden + Adjektive
...
2. werden as a hilfsverb
	...
	- werden + PASSIV
		- Ist dein Auto kaputt? Ja, Aber morgen wird es repariert
		- Wirst du am Flughafen abgeholt? Ja, ich werde von Peter abgeholt
		- Ist alles okay mit deinem Hund? Ja, er ist gestern operiert worden
	- werden + Konj II
		- ich würde
		- du würdest
		- er/sie/es würde
